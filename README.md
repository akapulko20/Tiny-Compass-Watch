...
<p align="center">Figure 1. Circuit diagram of the Tiny Compass Watch
  ...
  The [MPU-9250](https://invensense.tdk.com/products/motion-tracking/9-axis/mpu-9250/) is a System in Package (SiP) that combines two chips: the MPU-6500, which contains a 3-axis gyroscope, a 3-axis accelerometer, and the AK8963 3-axis digital compass. An accelerometer data have been used for tilt compensation. 
