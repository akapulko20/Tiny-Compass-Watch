...
<p align="center">Figure 1. Circuit diagram of the Tiny Compass Watch
  ...
  The [MPU-9250](https://invensense.tdk.com/products/motion-tracking/9-axis/mpu-9250/) is a System in Package (SiP) that combines two chips: the MPU-6500, which contains a 3-axis gyroscope, a 3-axis accelerometer, and the AK8963 3-axis digital compass. A 3-axis accelerometer have been used for tilt compensation (theoretical details can be found [here](https://ieeexplore.ieee.org/abstract/document/838300)). The AK8963 has resolution of 16-bits (0.15 µT per LSB) which is enough to detect Earth's magnetic field (50-60 µT). Although the program designed for MPU-9250,  it could be relatively easy changed for another IMU chip with I2C interface (e.g. newer 9-axis part from TDK [ICM-20948](https://invensense.tdk.com/download-pdf/migrating-from-mpu-9250-to-icm-20948/) or [LSM303C](https://www.st.com/en/mems-and-sensors/lsm303c.html)).
